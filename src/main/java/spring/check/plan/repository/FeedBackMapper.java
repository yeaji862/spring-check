...
public interface FeedBackMapper {
    ...
    @Insert("insert into \"feedBack\" (seq , \"fbContent\" , \"createDate\" , \"userNum\")\n" +
            "select seq, #{content}, \"createDate\" , \"userNum\" from \"habitSchedule\" where \"userNum\" = #{userNum} and \"createDate\" = #{createDate}")
    int uploadFeedBack(@Param("userNum") int userNum, @Param("createDate") String createDate, @Param("content") String content);
